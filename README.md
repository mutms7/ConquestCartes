...
An original fantasy deck-builder, built in Godot 4.7. You start with a thin deck of coins and homesteads, buy better cards from a rotating market, and race to turn the final contents of your deck into victory points. If you've played Dominion, you'll feel at home fast. I wanted that same "build an engine from almost nothing" feeling, but with my own cards, my own painted art, and my own features: I added relics and time-based combat!

🌐 **Play it online:** [conquest-cartes.vercel.app](https://conquest-cartes.vercel.app/)

![The ConquestCartes home screen, with the Sunspire tower artwork](docs/screenshots/home.png)

![A game in progress: the market of action cards, your treasury and estates, and your opening hand](docs/screenshots/table.png)
