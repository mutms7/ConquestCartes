...
func _initialize() -> void:
	...
	main_ui.game_state.player.coins = 6
	main_ui._refresh_ui()
	var market_button := _find_card_button(_market_container(), "royal_charter")
	_check(market_button != null, "Royal Charter should render in the market.")
